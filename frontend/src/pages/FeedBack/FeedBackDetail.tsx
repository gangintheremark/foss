  ...
  return (
    <div className="flex flex-col justify-center items-center">
      <div className="w-11/12">
        ...
        />
        <div className="w-full max-w-[1065px] min-h-[615px] bg-laptop bg-no-repeat flex gap-16 justify-center items-center">
          <div
            className="h-[400px] w-[384px] border-[1px] border-solid border-[rgba(28,31,34,0.2)]
           overflow-scroll rounded-2xl px-4 py-6 flex flex-col gap-y-2"
          >
            {click !== -1 &&
              detail.map((e, i) => {
                return (
                  <div className="flex gap-1.5 font-bold text-sm" key={i}>
                    <div className="text-[rgba(28,31,41,0.4)]">{e.time}</div>
                    <div
                      className={`${
                        e.isTitle ? ' text-main-color' : ' text-[rgba(28,31,41,0.64)]'
                      }`}
                    >
                      {e.content}
                    </div>
