...
import blueTalkImage from '@assets/image/말풍1.png';
import pinkTalkImage from '@assets/image/말풍2.png';
import meetingImage from '@assets/image/미팅아이콘.png';
import robot from '@assets/image/robot.png';
import kakaoIcon from '@assets/image/kakaoicon.png';
import naverIcon from '@assets/image/navericon.png';
import googleIcon from '@assets/image/googleicon.png';

const Login: React.FC = () => {
  const REST_API_KEY = '백엔드한테 달라하자1';
  const REDIRECT_URI = '백엔드한테 달라하자2';
  const kakoLink = `https://kauth.kakao.com/oauth/authorize?client_id=${REST_API_KEY}&redirect_uri=${REDIRECT_URI}&response_type=code`;
  ...
  return (
    <div className="w-full overflow-hidden">
      <div className="w-full h-screen absolute top-0 left-0 bg-white flex justify-center items-center">
        <div className="w-[1440px] h-[950px] relative overflow-hidden bg-white flex flex-col">
          <div className="flex flex-col absolute left-[93px] top-[100px]">
          ...
          <div className="flex flex-col absolute left-[863px] top-[180px] w-[400px] h-[76px] space-y-2">
          ...
          <div>
            <div className="flex flex-col items-center absolute left-[874.5px] top-[359.5px] space-y-4">
              <div
              ...
              <div className="relative w-[423px] h-[66px] flex items-center bg-[#03c75a] rounded-md">
                ...
                <p className="flex-grow text-lg font-bold text-center text-white">
                  네이버로 시작하기
                </p>
              </div>
            </div>
            <div className="flex flex-col absolute left-[875px] top-[619px] gap-2.5 p-2.5">
            ...
            <defs>
              ...
              >
                ...
                <feBlend
                  ...
                  result="effect1_dropShadow_301_224"
                />
                <feBlend
                  mode="normal"
                  in="SourceGraphic"
